...
%run test_gen_classifer.py --config_file ./configs/effb4_meta_default1_test.yaml MISC.TTA True MISC.N_TTA 20 MISC.ONLY_TEST True MISC.LOGFILE_EVAL log_eval_test.txt


%run test_gen_classifer.py --config_file ./configs/effb4_meta_default_19a_test.yaml MISC.TTA True MISC.N_TTA 20 MISC.ONLY_TEST True MISC.LOGFILE_EVAL log_eval_test.txt

%run test_gen_classifer.py --config_file ./configs/effb4_meta_default_19_unk_test.yaml MISC.TTA True MISC.N_TTA 20 MISC.ONLY_TEST True MISC.LOGFILE_EVAL log_eval_test.txt
