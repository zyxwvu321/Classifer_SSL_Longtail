...
fn_ISIC18_presegbox = './dat/bbox_isic18_test.csv'
fn_ISIC18_colorgain = './dat/ISIC18_colorgain_test.csv'
fd_im = '../data/ISIC18/task3/ISIC2018_Task3_Test_Input'
...
for idx, fn in enumerate(tqdm(flist)):
    ...
    info_list.append([Path(fn).stem, hh, ww,0, *meta, *bbox, *color_gain])
...
df.to_csv('./dat/ISIC18_info_test.csv', index=False)