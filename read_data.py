...
import cv2
#%%
src_im_fd = '/home/minjie/dataset/ISIC/ISIC2018_Task3_Training_Input/'
tar_im_fd = './data/ISIC/train18/'

df = pd.read_csv('./data/ISIC/ISIC2018_Task3_Training_GroundTruth.csv')
